...
public class ItemController {
    ...
    public String postAddProduct(Model model, @PathVariable long id, HttpServletRequest request) {
    ...
    public String getCartPage(Model model, HttpServletRequest request) {
        ...
        List<CartDetail> cartDetails = this.productService.getAllCartDetailByUser(email);
        double totalPrice = 0;
